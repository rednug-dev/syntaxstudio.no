...
import { Camera, Video, ArrowLeft, ArrowRight, Instagram, Award, Check, Flame, Swords } from "lucide-react";
...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: "Meta.workBurger" });
  const path = locale === "no" ? "/work/burger" : "/en/work/burger";
  return {
    title: t("title"),
    description: t("description"),
    alternates: {
      canonical: path,
      languages: { no: "/work/burger", en: "/en/work/burger", "x-default": "/work/burger" },
    },
    openGraph: {
      title: t("title"),
      description: t("description"),
...
export default async function BurgerWorkPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  const { locale } = await params;
  const t = await getTranslations("About.WorkIntro.projects.burger.page");
  const metaT = await getTranslations({ locale, namespace: "Meta.workBurger" });
  ...
  return (
    <>
      <Script
        id="ld-burger-breadcrumb"
        type="application/ld+json"
        dangerouslySetInnerHTML={{ __html: JSON.stringify(breadcrumb) }}
      />
      <Script
        id="ld-burger-article"
        type="application/ld+json"
        ...
        <main id="main-content" className="flex-1 pb-24">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
                  ...
                  <div className="lg:row-span-2 rounded-[2rem] overflow-hidden border border-white/5 shadow-xl group aspect-[9/16] lg:aspect-auto relative">
                      <Image 
                        ...
                        alt="Signaturburger – produktbilde"
                        fill
                        sizes="(max-width: 768px) 100vw, 25vw"
                  ...
                  <div className="rounded-[2rem] overflow-hidden border border-white/5 shadow-xl group aspect-square relative">
                      <Image 
                        ...
                        alt="Chicken fries – kampanjeplakat"
                        fill
                        sizes="(max-width: 768px) 100vw, 25vw"
                  ...
                  <div className="rounded-[2rem] overflow-hidden border border-white/5 shadow-xl group aspect-square relative">
                      <Image 
                        ...
                        alt="Burger – nærbilde av detaljer"
                        fill
                        sizes="(max-width: 768px) 100vw, 25vw"
                  ...
                  <div className="rounded-[2rem] overflow-hidden border border-white/5 bg-black shadow-xl group aspect-square relative">
                      <VideoCard 
                          ...
                          poster="/burger/fries-loaded-poster.webp"
                          aspectRatio="square"
                          alwaysPlay
                          preload={false}
          ...
          <section className="container mx-auto px-4 py-24">
            <div className="max-w-3xl mx-auto">
              ...
              <p className="mt-10 text-sm text-muted-foreground/70 leading-relaxed border-t border-white/5 pt-6">
                {t("disclaimer")}
              </p>
            </div>
          </section>
